...
<div class="sidebar border-r-2 border-gray-700 bg-gray-800 text-white min-h-screen flex flex-col justify-between w-[15%]">
    <div class="py-6">
        <h1 class="text-2xl font-semibold mb-8 text-gray-300 text-center hover:text-gray-300">
